...
\hypertarget{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e}{}\label{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e}\index{Streams Working Group@{Streams Working Group}}
\label{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e_autotoc_md2968}%
\Hypertarget{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e_autotoc_md2968}%
...
For the current list of WG members, see the project \href{./README.md\#current-project-team-members}{\texttt{ README.\+md}}.\hypertarget{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e_autotoc_md2969}{}\doxysubsection{\texorpdfstring{Collaborators}{Collaborators}}\label{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e_autotoc_md2969}
...
Collaborators may opt to elevate significant or controversial modifications, or modifications that have not found consensus to the WG for discussion by assigning the {\itshape {\bfseries{WG-\/agenda}}} tag to a pull request or issue. The WG should serve as the final arbiter where required.

For the current list of Collaborators, see the project \href{./README.md\#members}{\texttt{ README.\+md}}.\hypertarget{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e_autotoc_md2970}{}\doxysubsection{\texorpdfstring{WG Membership}{WG Membership}}\label{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e_autotoc_md2970}
...
No more than 1/3 of the WG members may be affiliated with the same employer. If removal or resignation of a WG member, or a change of employment by a WG member, creates a situation where more than 1/3 of the WG membership shares an employer, then the situation must be immediately remedied by the resignation or removal of one or more WG members affiliated with the over-\/represented employer(s).\hypertarget{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e_autotoc_md2971}{}\doxysubsection{\texorpdfstring{WG Meetings}{WG Meetings}}\label{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e_autotoc_md2971}
...
Any community member or contributor can ask that something be added to the next meeting\textquotesingle{}s agenda by logging a Git\+Hub Issue. Any Collaborator, WG member or the moderator can add the item to the agenda by adding the {\itshape {\bfseries{WG-\/agenda}}} tag to the issue.
...
The moderator is responsible for summarizing the discussion of each agenda item and sends it as a pull request after the meeting.\hypertarget{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e_autotoc_md2972}{}\doxysubsection{\texorpdfstring{Consensus Seeking Process}{Consensus Seeking Process}}\label{md_backend_2node__modules_2readable-stream_2_g_o_v_e_r_n_a_n_c_e_autotoc_md2972}
The WG follows a \href{http://en.wikipedia.org/wiki/Consensus-seeking_decision-making}{\texttt{ Consensus Seeking}} decision-\/making model.
