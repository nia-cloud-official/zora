\chapter{depd}
\hypertarget{md_backend_2node__modules_2depd_2_readme}{}\label{md_backend_2node__modules_2depd_2_readme}\index{depd@{depd}}
\label{md_backend_2node__modules_2depd_2_readme_autotoc_md769}%
\Hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md769}%
...
\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md770}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md770}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s API to no longer display or track deprecations.\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md771}{}\doxysection{\texorpdfstring{API}{API}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md771}
...
{\bfseries{NOTE}} this library has a similar interface to the {\ttfamily debug} module, and this module uses the calling file to get the boundary for the call stacks, so you should always create a new {\ttfamily deprecate} object in each file and not within some central file.\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md772}{}\doxysubsection{\texorpdfstring{depd(namespace)}{depd(namespace)}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md772}
Create a new deprecate function that uses the given namespace name in the messages and will display the call site prior to the stack entering the file this function was called from. It is highly suggested you use the name of your module as the namespace.\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md773}{}\doxysubsection{\texorpdfstring{deprecate(message)}{deprecate(message)}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md773}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md774}{}\doxysubsection{\texorpdfstring{deprecate.\+function(fn, message)}{deprecate.\+function(fn, message)}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md774}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md775}{}\doxysubsection{\texorpdfstring{deprecate.\+property(obj, prop, message)}{deprecate.\+property(obj, prop, message)}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md775}
...
If the property is a data descriptor, it will be converted to an accessor descriptor in order to display the deprecation message.\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md776}{}\doxysubsection{\texorpdfstring{process.\+on(\textquotesingle{}deprecation\textquotesingle{}, fn)}{process.\+on(\textquotesingle{}deprecation\textquotesingle{}, fn)}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md776}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md777}{}\doxysubsection{\texorpdfstring{process.\+env.\+NO\+\_\+\+DEPRECATION}{process.\+env.\+NO\+\_\+\+DEPRECATION}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md777}
...
{\bfseries{NOTE}} This will not suppress the deperecations given to any "{}deprecation"{} event listeners, just the output to STDERR.\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md778}{}\doxysubsection{\texorpdfstring{process.\+env.\+TRACE\+\_\+\+DEPRECATION}{process.\+env.\+TRACE\+\_\+\+DEPRECATION}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md778}
...
{\bfseries{NOTE}} This will not trace the deperecations silenced by {\ttfamily NO\+\_\+\+DEPRECATION}.\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md779}{}\doxysection{\texorpdfstring{Display}{Display}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md779}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md780}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md780}
\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md781}{}\doxysubsection{\texorpdfstring{Deprecating all calls to a function}{Deprecating all calls to a function}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md781}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md782}{}\doxysubsection{\texorpdfstring{Conditionally deprecating a function call}{Conditionally deprecating a function call}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md782}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md783}{}\doxysubsection{\texorpdfstring{Deprecating property access}{Deprecating property access}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md783}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2depd_2_readme_autotoc_md784}{}\doxysection{\texorpdfstring{License}{License}}\label{md_backend_2node__modules_2depd_2_readme_autotoc_md784}
