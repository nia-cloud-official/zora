\chapter{minipass}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e}{}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e}\index{minipass@{minipass}}
\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2170}%
\Hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2170}%
...
\href{https://docs.google.com/spreadsheets/d/1oObKSrVwLX_7Ut4Z6g3fZW-AX1j1-k6w-cDsrkaSbHM/edit\#gid=0}{\texttt{ It\textquotesingle{}s very fast}} for objects, strings, and buffers.
...
\end{DoxyItemize}\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2171}{}\doxysection{\texorpdfstring{Differences from Node.\+js Streams}{Differences from Node.\+js Streams}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2171}
...
You can avoid most of these differences entirely (for a very small performance penalty) by setting {\ttfamily \{async\+: true\}} in the constructor options.\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2172}{}\doxysubsection{\texorpdfstring{Timing}{Timing}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2172}
...
\DoxyCodeLine{const\ stream\ =\ new\ Minipass(\{\ async:\ true\ \})}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2173}{}\doxysubsection{\texorpdfstring{Exception\+: Async Opt-\/\+In}{Exception\+: Async Opt-\/\+In}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2173}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2174}{}\doxysubsection{\texorpdfstring{No High/\+Low Water Marks}{No High/\+Low Water Marks}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2174}
...
Since nothing is ever buffered unnecessarily, there is much less copying data, and less bookkeeping about buffer capacity levels.\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2175}{}\doxysubsection{\texorpdfstring{Hazards of Buffering (or\+: Why Minipass Is So Fast)}{Hazards of Buffering (or\+: Why Minipass Is So Fast)}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2175}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2176}{}\doxysubsection{\texorpdfstring{Immediately emit {\ttfamily end} for empty streams (when not paused)}{Immediately emit {\ttfamily end} for empty streams (when not paused)}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2176}
...
However, this is {\itshape usually} not a problem because\+:\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2177}{}\doxysubsection{\texorpdfstring{Emit {\ttfamily end} When Asked}{Emit {\ttfamily end} When Asked}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2177}
...
To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the `\textquotesingle{}end'\`{} event whenever it is emitted.\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2178}{}\doxysubsection{\texorpdfstring{Emit {\ttfamily error} When Asked}{Emit {\ttfamily error} When Asked}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2178}
...
This makes it much more difficult to end up trying to interact with a broken stream, if the error handler is added after an error was previously emitted.\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2179}{}\doxysubsection{\texorpdfstring{Impact of "{}immediate flow"{} on Tee-\/streams}{Impact of "{}immediate flow"{} on Tee-\/streams}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2179}
...
All of the hazards in this section are avoided by setting {\ttfamily \{ async\+: true \}} in the Minipass constructor, or by setting {\ttfamily stream.\+async = true} afterwards. Note that this does add some overhead, so should only be done in cases where you are willing to lose a bit of performance in order to avoid having to refactor program logic.\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2180}{}\doxysection{\texorpdfstring{USAGE}{USAGE}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2180}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2181}{}\doxysubsection{\texorpdfstring{OPTIONS}{OPTIONS}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2181}
...
\end{DoxyItemize}\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2182}{}\doxysubsection{\texorpdfstring{API}{API}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2182}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2183}{}\doxysubsection{\texorpdfstring{Methods}{Methods}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2183}
...
\item {\ttfamily options.\+proxy\+Errors} -\/ Boolean, proxy {\ttfamily error} events from the source stream to the destination stream. Note that errors are {\itshape not} proxied after the pipeline terminates, either due to the source emitting `\textquotesingle{}end'{\ttfamily or manually unpiping with}src.\+unpipe(dest){\ttfamily . Default}false{\ttfamily . \texorpdfstring{$\ast$}{*}}on(ev, fn){\ttfamily ,}emit(ev, fn){\ttfamily -\/ Minipass streams are Event\+Emitters. Some events are given special treatment, however. (See below under "{}events"{}.) \texorpdfstring{$\ast$}{*}}promise(){\ttfamily -\/ Returns a Promise that resolves when the stream emits }end{\ttfamily , or rejects if the stream emits}error{\ttfamily . \texorpdfstring{$\ast$}{*}}collect(){\ttfamily -\/ Return a Promise that resolves on}end{\ttfamily with an array containing each chunk of data that was emitted, or rejects if the stream emits}error{\ttfamily . Note that this consumes the stream data. \texorpdfstring{$\ast$}{*}}concat(){\ttfamily -\/ Same as}collect(){\ttfamily , but concatenates the data into a single Buffer object. Will reject the returned promise if the stream is in object\+Mode, or if it goes into object\+Mode by the end of the data. \texorpdfstring{$\ast$}{*}}read(n){\ttfamily -\/ Consume}n{\ttfamily bytes of data out of the buffer. If}n{\ttfamily is not provided, then consume all of it. If}n{\ttfamily bytes are not available, then it returns null. \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}\+Note\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} consuming streams in this way is less efficient, and can lead to unnecessary Buffer copying. \texorpdfstring{$\ast$}{*}}destroy(\mbox{[}er\mbox{]}){\ttfamily -\/ Destroy the stream. If an error is provided, then an }\textquotesingle{}error\textquotesingle{}{\ttfamily event is emitted. If the stream has a}close(){\ttfamily method, and has not emitted a}\textquotesingle{}close\textquotesingle{}{\ttfamily event yet, then}stream.\+close(){\ttfamily will be called. Any Promises returned by}.promise(){\ttfamily ,}.collect(){\ttfamily or }.concat()\`{} will be rejected. After being destroyed, writing to the stream will emit an error. No more data will be emitted if the stream is destroyed, even if it was previously buffered.
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2184}{}\doxysubsection{\texorpdfstring{Properties}{Properties}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2184}
...
\item {\ttfamily buffer} A \href{http://npm.im/yallist}{\texttt{ yallist}} linked list of chunks written to the stream that have not yet been emitted. (It\textquotesingle{}s probably a bad idea to mess with this.)
\item {\ttfamily pipes} A \href{http://npm.im/yallist}{\texttt{ yallist}} linked list of streams that this stream is piping into. (It\textquotesingle{}s probably a bad idea to mess with this.)
...
\end{DoxyItemize}\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2185}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2185}
...
\item {\ttfamily prefinish} An end-\/ish event that follows the same logic as {\ttfamily end} and is emitted in the same conditions where {\ttfamily end} is emitted. Emitted after `\textquotesingle{}end'{\ttfamily . \texorpdfstring{$\ast$}{*}}finish{\ttfamily An end-\/ish event that follows the same logic as}end{\ttfamily and is emitted in the same conditions where}end{\ttfamily is emitted. Emitted after }\textquotesingle{}prefinish\textquotesingle{}{\ttfamily . \texorpdfstring{$\ast$}{*}}close{\ttfamily An indication that an underlying resource has been released. Minipass does not emit this event, but will defer it until after}end{\ttfamily  has been emitted, since it throws off some stream libraries otherwise. \texorpdfstring{$\ast$}{*}}drain{\ttfamily Emitted when the internal buffer empties, and it is again suitable to}write(){\ttfamily into the stream. \texorpdfstring{$\ast$}{*}}readable{\ttfamily Emitted when data is buffered and ready to be read by a consumer. \texorpdfstring{$\ast$}{*}}resume{\ttfamily Emitted when stream changes state from buffering to flowing mode. (Ie, when}resume{\ttfamily is called,}pipe{\ttfamily is called, or a}data\`{} event listener is added.)
\end{DoxyItemize}\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2186}{}\doxysubsection{\texorpdfstring{Static Methods}{Static Methods}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2186}
...
\end{DoxyItemize}\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2187}{}\doxysection{\texorpdfstring{EXAMPLES}{EXAMPLES}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2187}
Here are some examples of things you can do with Minipass streams.\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2188}{}\doxysubsection{\texorpdfstring{simple "{}are you done yet"{} promise}{simple "{}are you done yet"{} promise}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2188}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2189}{}\doxysubsection{\texorpdfstring{collecting}{collecting}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2189}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2190}{}\doxysubsection{\texorpdfstring{collecting into a single blob}{collecting into a single blob}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2190}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2191}{}\doxysubsection{\texorpdfstring{iteration}{iteration}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2191}
...
\DoxyCodeLine{\ \ if\ (i-\/-\/\ >\ 0)}
\DoxyCodeLine{\ \ \ \ mp.write(Buffer.from('foo\(\backslash\)n',\ 'utf8'))}
\DoxyCodeLine{\ \ else\ \{}
\DoxyCodeLine{\ \ \ \ mp.end()}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2192}{}\doxysubsection{\texorpdfstring{subclass that {\ttfamily console.\+log()}s everything written into it}{subclass that {\ttfamily console.\+log()}s everything written into it}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2192}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2193}{}\doxysubsection{\texorpdfstring{same thing, but using an inline anonymous class}{same thing, but using an inline anonymous class}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2193}

\begin{DoxyCode}{0}
\DoxyCodeLine{//\ js\ classes\ are\ fun}
\DoxyCodeLine{someSource}
\DoxyCodeLine{\ \ .pipe(new\ (class\ extends\ Minipass\ \{}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2194}{}\doxysubsection{\texorpdfstring{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2194}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2195}{}\doxysubsection{\texorpdfstring{transform that creates newline-\/delimited JSON}{transform that creates newline-\/delimited JSON}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2195}
...
\end{DoxyCode}
\hypertarget{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2196}{}\doxysubsection{\texorpdfstring{transform that parses newline-\/delimited JSON}{transform that parses newline-\/delimited JSON}}\label{md_backend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md2196}
